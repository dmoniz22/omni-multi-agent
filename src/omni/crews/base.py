...
class BaseCrew(ABC):
    ...
    def __init__(self):
        """Initialize the crew with settings."""
    ...
    def execute(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.info(
            "Executing crew", crew_name=self.name, input_keys=list(input_data.keys())
        )
        ...
        try:
            ...
            logger.error("Crew execution failed", crew_name=self.name, error=str(e))
