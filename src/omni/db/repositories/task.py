...
class TaskRepository:
    ...
    async def create(
        ...
        try:
            ...
            logger.info(
                "Task created", task_id=str(task.id), session_id=str(session_id)
            )
            return task
    ...
    async def list_by_session(self, session_id: UUID) -> List[Task]:
        ...
        try:
            ...
            logger.error(
                "Failed to list tasks", session_id=str(session_id), error=str(e)
            )
...
class TaskStepRepository:
    ...
    async def create(
        ...
        try:
            ...
            logger.info(
                "Task step created", task_id=str(task_id), step_number=step_number
            )
            return step
    ...
    async def list_by_task(self, task_id: UUID) -> List[TaskStep]:
        ...
        try:
            ...
            logger.error(
                "Failed to list task steps", task_id=str(task_id), error=str(e)
            )
